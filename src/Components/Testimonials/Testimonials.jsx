          ...
          <li>
            <div className="slide">
              <div className="user-info">
                ...
                <p>Choosing to pursue my degreee at City University was one of the decision I have ever made. The suppportive community, state-of-the-art facilities and turly exceeded my expectations.</p>
            </div>
          </li>
