  ...
  return (
    <div className="contact">
      <div className="contact-col">
        <h3>
          Send us a message <img src={pegam_Icn} alt="" />
        </h3>
        <p>
          Feel free to reach out through contact form or find our contact
          informmation below. Your feedback, questions and suggestion are
        ...
        <ul>
          ...
          <li>
            <img src={loctionss_icon} alt="" />
            City: Peshawar Adbdara Road{" "}
          </li>
        </ul>
      </div>
      <div className="contact-col">
